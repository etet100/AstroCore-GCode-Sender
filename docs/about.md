---
title: About AstroCore
---

# About AstroCore

AstroCore is a GRBL/uCNC/FluidNC controller application with a built-in G-code visualizer, written in Qt.
...
AstroCore is under active development and considered a preview/prerelease. Some parts are stable and usable every day, while others are still changing.

Feedback, issue reports and pull requests are welcome.

## Useful links

- Source code: https://github.com/etet100/AstroCore-GCode-Sender
- Releases: https://github.com/etet100/AstroCore-GCode-Sender/releases
