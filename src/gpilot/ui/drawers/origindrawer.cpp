...
bool OriginDrawer::updateData(GLPalette &palette)
{
    ...
    m_billboardDrawable.addBillboard((QVector3D(10, 0, 0) + QVector3D(5, 0, 0)) * m_scale, "X", cx, 12.5f);
    m_billboardDrawable.addBillboard((QVector3D(0, 10, 0) + QVector3D(0, 5, 0)) * m_scale, "Y", cy, 12.5f);
    m_billboardDrawable.addBillboard((QVector3D(0, 0, 10) + QVector3D(0, 0, 5)) * m_scale, "Z", cz, 12.5f);
