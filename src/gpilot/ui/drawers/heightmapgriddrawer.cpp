...
{
    // Generowanie siatki trójkątów (poligonów)
    for (int i = 0; i < gridPointsX - 1; i++) {
        for (int j = 0; j < gridPointsY - 1; j++) {
            // Pobierz wartości wysokości dla czterech wierzchołków siatki
